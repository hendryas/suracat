                        ...
                        <div class="card-body">
                            <form id="formEditSoal">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kode_soal" value="{{ $soal->kode_soal }}" readonly>
                                </div>

                                <div class="mb-3">
                                    <label for="kategori" class="form-label">Kategori</label>
                                    <input type="text" class="form-control" name="kategori" value="{{ $soal->kategori }}">
                                </div>
                                ...
                                @foreach (['a', 'b', 'c', 'd', 'e'] as $opt)
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="opsi_{{ $opt }}" value="{{ $soal->{'opsi_'.$opt} }}" required>
                                    </div>
                                @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="jawaban_benar" required>
                                        ...
                                        @foreach (['A','B','C','D','E'] as $opt)
                                            <option value="{{ $opt }}" {{ $soal->jawaban_benar == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            $(document).ready(function () {
                $('#formEditSoal').on('submit', function (e) {
                    ...
                    $.ajax({
                        ...
                        error: function (xhr) {
                            Swal.fire('Error', 'Gagal memperbarui soal.', 'error');
                        }
                    });
                });
            });
